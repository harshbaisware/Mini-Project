<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myForm.aspx.cs" Inherits="kycSystem0.WebForm1" %>
         ...
         <form id="form_kycsystem" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div id="heading">
                                ...
                                <h2 style="text-align: left;">Application Form</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <table align="right" class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:FileUpload ID="imageFileUpload"  accept="image/*" onchange="preview_image(event)" runat="server" />
                                    ...
                                    <td>
                                        <asp:FileUpload ID="signFileUpload" accept="image/*" onchange="preview_sign(event)"  runat="server" />
                                ...
                                <tr>
                                    <td><img id="output_image" /></td>
                                    <td><img id="output_sign" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                         <label>Postal Code :</label><asp:RequiredFieldValidator ID="RequiredFieldValidator36" runat="server" ErrorMessage=" (Invalid Data)" ControlToValidate="txt3Postal" Font-Size="Small" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label>Mobile No :</label><asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ErrorMessage=" (Invalid Data)" Font-Size="Small" ForeColor="Red" SetFocusOnError="True" ControlToValidate="txt4Mobile"></asp:RequiredFieldValidator>
